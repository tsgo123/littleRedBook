<template>
  ...
  <div class="flex items-center ">
    ...
    <div class="h-full mx-auto flex items-center relative">
      ...
      <div class="ml-3 text-[#999] text-xs">由<a href="https://www.quanxiaoha.com/column/" target="_blank" class=" hover:text-gray-600">《失之桑榆,收之桑榆-ly》</a>开发</div>
      <!-- 搜索框容器 -->
      ...
      <!-- 右侧按钮容器 -->
      <div class="flex items-center">
        <a href="http://localhost:9090" target="_blank" class="text-gray-600 px-5 py-2.5 rounded-full hover:bg-gray-100 hover:text-gray-800">Minio</a>
        <a href="http://localhost:8848/nacos" target="_blank" class="text-gray-600 px-5 py-2.5 rounded-full hover:bg-gray-100 hover:text-gray-800">Nacos</a>
        <a href="http://localhost:7777/xxl-job-admin/" target="_blank" class="text-gray-600 px-5 py-2.5 rounded-full hover:bg-gray-100 hover:text-gray-800">XXL-JOB</a>
      </div>
    </div>
  </header>
  </div>
